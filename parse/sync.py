...
def main():
    """Функция запрашивает первую страницу с отзывами,
       сохраняет (предположително, в базу) данные, полученные из JSON,
       и, если в ответе присутствует параметр "next" - переходит к следующей странице
    """
